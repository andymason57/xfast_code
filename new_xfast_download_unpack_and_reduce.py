...
#global variables - path to download, results and lrzipped directories
base_dir = "/mnt/4tbdata/test_ls_epoch"
ls_results_dir = "/mnt/4tbdata/test_ls_results"
epoch_results_dir = "/mnt/4tbdata/test_ls_epoch"
lrztar_output_dir = "/mnt/4tbdata/test_ls_epoch_tarred"
...
def download_data(built_up_list):
    for str_row in built_up_list:
        ...
        try:
            ...
            # the in Call string use path to extractnested.py script and also need executable='/bin/bash'
        ...
        try:
            idl_call = "cd " + base_dir + " && idl -e xmmpipeworkingv29 -args " + " " + base_dir + "/" + str_row + " " + str_row
        ...
        try:
            remove_files = "cd " +  base_dir + "/" + str_row + " && rm aioclient " + " && rm " + str_row + ".tar"
        ...
        # try:
        #     fasper_data = base_dir + '/' + str_row
        #     print fasper_data
        #     new_call_to_lomb_scargle_FASPER.fasper(fasper_data, ls_results_dir)
        #     new_call_to_lomb_scargle_FASPER.plot_results(ls_results_dir, str_row)
        # except RuntimeError:
        #     logger.exception(
        #         'Some runtime error has occurred in main IDL reduction routine - check IDL console logs for ObsID: ',
        #         str_row)
